...
<?php echo $_SESSION['product_qty_label']." ".$_SESSION['product_type_label'].PHP_EOL; ?>
Best Before :- <?php echo  $_SESSION['product_exdate_label'] ; ?></String>
            ...
            <Cell>
                <BarcodeObject>
                    ...
                    <TextFont Family="Arial" Size="1o" Bold="False" Italic="False" Underline="False" Strikeout="False" />

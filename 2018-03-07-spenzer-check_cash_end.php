    ...
    <div class="wrapper">
        <div class="keypad-popup">
            ...
            <div class="keypad-row">
                ...
                <button <?php if($_SESSION['is_super_admin'] != 1){ ?> disabled="disabled" <?php } ?> value="Open Cash" id="open_cash" type="button" class="keypad-key bottom-button">Open Cash</button>
            ...
            <div id="table-scroll">
                <table border="1">
                    ...
                    <tr>
                        ...
                        <th><span class="text">Day Total</span></th>
                    ...
                    <?php  foreach($Mainarray as $each_data){?>
                        <tr>
                            ...
                            <td align="center" style="color: red;background-color: moccasin"><?php echo ($each_data ['startCash'] + $each_data ['CashSales'] + $each_data ['CardSales'] ) - ($each_data ['BD'])  ;  ?></td>

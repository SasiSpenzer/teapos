...
if(isset($_POST['scan_add'])){

    $ProductBarcode = trim($_POST['product_barcode']);
    $product_qty = $_POST['product_qty'];

    $product_obj = new Product();
    $product_id = $product_obj->get_product_by_barcode_add($ProductBarcode);

    $product_data = $product_obj->list_priduct_by_product_id($product_id['product_id']);
    ...
    $product_obj->update_new_product($data_array,$product_id['product_id']);
...
<form method="post" action="">
  <div class="scan-add-callout">
    ...
    <p>
        <span class="col-sm-4"> Product Barcode</span><input id="product_barcode" name="product_barcode" type="text" class="col-sm-6"></p>
        <input value="Add" type="submit" name="scan_add" class="btn btn-primary btn-scan-add">

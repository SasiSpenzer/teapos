...
function __backup_mysql_database($params)
{
    ...
    if (($result = fwrite($fp, $contents))) {
        ...
        echo "<h2 align='center'>Please wait while system is processing your request</h2>";
        sleep(5);
...
$para = array(
    ...
    'db_uname' => 'root',  //user
    'db_password' => '', //pass
    'db_to_backup' => 'teapos', //database name
    'db_backup_path' => 'C:Users/Win8.1-L/Desktop', //where to backup
